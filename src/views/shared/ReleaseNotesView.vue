...
const notes = [
  {
    ...
    items: [
      ...
      '가계부 캘린더 탭 이름 변경 (일일 → 일별), 스와이프로 수정/삭제하는 방법 안내문구 추가',
      '가계부 내역 항목 레이아웃 개선 — 카테고리를 왼쪽에, 메모·결제수단을 세로로 배치',
      '가계부 관리(카테고리/결제수단/즐겨찾기) 목록 간격 축소, 삭제 시 확인창 추가',
      '엑셀 가져오기 시 카테고리명 앞 이모지가 잘려서 저장되던 문제 수정',
      '가계부 캘린더 추가 버튼 크기 축소, 하단 메뉴 아이콘 위치를 살짝 위로 조정',
    ],
  },
  {
    version: 'v1.0.6',
